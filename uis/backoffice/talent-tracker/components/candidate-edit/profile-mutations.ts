import { patchCandidate, replaceCandidate } from "@backoffice/talent-tracker/lib/api";

import type { CandidateProfile } from "@backoffice/talent-tracker/components/candidate-edit/profile-model";
