...
import { NewCandidateFields } from "@/components/new-candidate/new-candidate-fields";
import { SaveCandidateBar } from "@/components/new-candidate/save-candidate-bar";
import { useNewCandidateForm } from "@/components/new-candidate/use-new-candidate-form";
  ...
  return (
    <div className="min-h-screen">
      ...
      <main className="mx-auto max-w-7xl px-4 py-6 sm:px-6 lg:px-8">
        ...
        <Link href={returnTo} className="mt-4 inline-flex items-center gap-1 rounded-md border border-[var(--hc-border)] bg-white px-3 py-2 text-sm">
